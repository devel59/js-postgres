 ...
 * @property {DatabaseInterface_query} query
 ...
 */
/**
 * @callback DatabaseInterface_query
 * @param {QueryConfig} queryConfig
...
function makeDatabase(cls) {
     ...
     * @returns {Promise<Array<*>>}
     */
    cls.prototype.any = async function (queryConfig) {
     ...
     * @returns {Promise<null>}
     */
    cls.prototype.none = async function (queryConfig) {
        const result = await this.query(queryConfig);
     ...
     * @returns {Promise<*>}
     */
    cls.prototype.one = async function (queryConfig) {
        const result = await this.query(queryConfig);
        if (result.rows.length === 0) {
     ...
     * @returns {Promise<*>}
     */
    cls.prototype.oneOrNone = async function (queryConfig) {
        const result = await this.query(queryConfig);
        if (result.rows.length > 1) {
            throw new QueryResultManyError();
        }
     ...
     * @returns {Promise<Array<*>>}
     */
    cls.prototype.many = async function (queryConfig) {
        const result = await this.query(queryConfig);
        if (result.rows.length === 0) {
            throw new QueryResultNoneError();
        }
...
function makeInnerDatabase(cls) {
     ...
     * @returns {Promise<PgResult>}
     */
    cls.prototype.query = async function (queryConfig) {
        const logData = {
            query: queryConfig,
            duration: {
                query: 0
